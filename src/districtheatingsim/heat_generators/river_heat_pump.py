...
class RiverHeatPump(HeatPump):
    ...
    def get_display_text(self) -> str:
        ...
        return (
            f"{self.name}: Wärmeleistung FW WP: {self.Wärmeleistung_FW_WP:.1f} kW, "
    ...
    def extract_tech_data(self) -> tuple[str, str, str, str]:
        ...
        costs = (
            f"Investitionskosten Flusswärmenutzung: {river_cost:.1f} €, Investitionskosten Wärmepumpe: {hp_cost:.1f} €"
        )
