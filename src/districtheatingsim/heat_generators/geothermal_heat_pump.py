...
class Geothermal(HeatPump):
    ...
    def __init__(
        ...
        spez_Bohrkosten: float = 100,
        spez_Entzugsleistung: float = 50,
        Vollbenutzungsstunden: float = 2400,
        Abstand_Sonden: float = 10,
        spezifische_Investitionskosten_WP: float = 1000,
        min_Teillast: float = 0.2,
        min_area_geothermal: float = 0,
        max_area_geothermal: float = 5000,
        min_depth_geothermal: float = 0,
        max_depth_geothermal: float = 400,
    ) -> None:
        """
    ...
    def calculate_results(self, duration: float) -> None:
        ...
        self.spez_Investitionskosten_Erdsonden = (
            self.Investitionskosten_Sonden / self.max_Wärmeleistung if self.max_Wärmeleistung > 0 else 0
        )
    ...
    def get_display_text(self) -> str:
        ...
        """
        return (
            f"{self.name}: Fläche Sondenfeld: {self.Fläche} m², Bohrtiefe: {self.Bohrtiefe} m, "
    ...
    def extract_tech_data(self) -> tuple[str, str, str, str]:
        ...
        dimensions = (
            f"Fläche: {self.Fläche:.1f} m², Bohrtiefe: {self.Bohrtiefe:.1f} m, "
        ...
        costs = f"Investitionskosten Sondenfeld: {borehole_cost:.1f} €, Investitionskosten Wärmepumpe: {hp_cost:.1f} €"
