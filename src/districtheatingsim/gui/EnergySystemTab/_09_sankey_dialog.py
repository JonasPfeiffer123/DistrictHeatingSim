...
class SankeyDialog(QDialog):
    ...
    def __init__(self, results=None, heat_demand=None, parent=None):
    ...
    def plotSankey(self):
        ...
        jahreswärmebedarf_gebäude = self.heat_demand  # Total building heat demand (input)
...
if __name__ == "__main__":
    ...
    dialog = SankeyDialog(results=results, heat_demand=4100)
    dialog.show()
    sys.exit(app.exec_())
