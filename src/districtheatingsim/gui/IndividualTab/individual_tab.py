...
from districtheatingsim.gui.EnergySystemTab._04_technology_dialogs import TechInputDialog  # Import your dialogs
    ...
    def extract_tech_data(self, tech, building_id):
        ...
        try:
            if isinstance(tech, GasBoiler):
                dimensions = f"th. Leistung: {tech.thermal_capacity_kW:.2f} kW"
