...
class CHP:
    ...
    def get_inlet_temp(self):
        """
        Gibt die aktuelle Eingangstemperatur des BHKW zurück.
        Diese Temperatur kann abhängig vom Modell festgelegt oder als Rücklauftemperatur verwendet werden.
        """
        return self.T_ruecklauf  # Beispiel: Rücklauftemperatur als BHKW-Eingangstemperatur
