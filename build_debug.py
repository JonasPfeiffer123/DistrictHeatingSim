...
def build_with_debug():
    ...
    cmd = ["pyinstaller", "--clean", "--noconfirm", "--log-level=DEBUG", "DistrictHeatingSim.spec"]
...
def move_user_data_outside():
    ...
    for folder in folders_to_move:
        ...
        possible_sources = [os.path.join(internal, folder), os.path.join(internal, "districtheatingsim", folder)]
